...
<link
	...
	rel="stylesheet">
<link
	href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@400;700&family=Oswald:wght@600&display=swap"
	rel="stylesheet">
<style>
body {
...
.banner-text h1 {
	font-family: 'Oswald', sans-serif;
	font-size: 3.5rem;
	text-shadow: 2px 2px 10px #EF0107;
}
...
<body>
    ...
    <c:forEach var="adminBoard" items="${adminBoardList}" end="2">
        <tr class="table-light"> <td class="fw-bold text-danger text-center">공지</td>
            ...
            <td><fmt:formatDate value="${adminBoard.regDate}" pattern="yyyy-MM-dd" /></td>
    ...
    <c:choose>
        <c:when test="${not empty boardList}">
            <c:forEach var="board" items="${boardList}" end="9">
                <tr>
                    ...
                    <td>${board.goodPoint}</td>
                </tr>
            </c:forEach>
        </c:when>
        <c:when test="${empty adminBoardList and empty boardList}">
            <tr>
                <td colspan="5" class="text-center py-5 text-muted">게시글이 존재하지 않습니다.</td>
            </tr>
        </c:when>
    </c:choose>
</tbody>
		...
		<div class="text-end mt-3">
			<c:if test="${not empty loginUser}">
				<a href="/community/board/insertForm"
					class="btn btn-danger btn-sm me-2">글쓰기</a>
			</c:if>
			<a href="/community/board/list" class="btn btn-outline-dark btn-sm">전체
				보기</a>
		</div>
	</section>
	...
	<section class="container mb-5">
		<div class="match-link-banner">
			<div class="banner-content">
				...
				<a href="https://www.arsenal.com/fixtures" target="_blank"
					class="btn btn-ars-outline"> GO TO OFFICIAL FIXTURES </a>
			</div>
		</div>
	</section>
	...
	<section class="container my-5">
		<div class="row g-4">
			...
			<div class="col-md-4">
				<a href="https://www.arsenal.com/history" target="_blank"
					class="quick-card-link">
			...
			<div class="col-md-4">
				<a href="https://www.arsenal.com/fans" target="_blank"
					class="quick-card-link">
					<div class="quick-card">
						<div class="card-icon">📢</div>
						<h3>SUPPORTERS</h3>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 text-md-end footer-info">
					...
					<p>
						<b>연락처 :</b> 010-8735-4875
					</p>
					<p>
						<b>이메일 :</b> ohjh4875@gmail.com
					</p>
					<p class="mt-3">&copy; 2026 Arsenal Fan Community. All rights
						reserved.</p>
				</div>
			</div>
		</div>
